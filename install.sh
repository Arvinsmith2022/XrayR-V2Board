...
install_XrayR() {
    ...
    file="https://github.com/Arvinsmith2022/XrayR-V2Board/raw/main/XrayR.service"
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://cdn.jsdelivr.net/gh/arvinsmith2022/XrayR-V2Board/config.yml -O /etc/XrayR/config.yml
